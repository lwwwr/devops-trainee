...
#   vpc_security_group_ids = [aws_security_group.alavruschik_sg_vpc_traffic.id, aws_security_group.alavruschik_sg_incoming.id]
#   iam_database_authentication_enabled = false
#   db_subnet_group_name = aws_db_subnet_group.alavruschik_rds_subnet_group.id
#   final_snapshot_identifier = "alavr-snapshot1"
#   name = "helloworld"
#   username = "helloworld"
#   password= "helloworld"
#   multi_az = true
